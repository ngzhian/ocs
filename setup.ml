...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4771c47c2a49ff59e68c2256ba8fc7d4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_spec", []))];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "ocs"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "ocs_main.ml"});
               Executable
                 ({
                     cs_name = "test_spec";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_spec.ml"});
               Test
                 ({
                     cs_name = "spec";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\n\240\219\024l\184&\144\233^\155P\144\224\016_";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
