...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2f3552c4944198497d9d4f93d09d3c8a) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mustache", None);
                           FindlibPackage ("ezjsonm", None);
                           FindlibPackage ("rss", None)
                        ];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ocs.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "?\017\024\031c\179\021\213\227z\184\205\169Y2\026";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
